...
if __name__ == '__main__':
    ...
    # rho
    rho_set = np.arange(1.70, 1.8, 0.05)
    rms_error = []
    for rho in rho_set:
        model_1 = Model('fhn', init_value=(0, 1.0), t=(0, 400, 0.01), args=(0.1, 10, 1.0, f), N=400, rho=rho,
                        sigma=1.0, bias=1.0, alpha=1.0, beta=1e-08, normalize=False)
        # print(model_1)
    ...
    plt.figure()
    plt.plot(rho_set, rms_error, 'bo')
    plt.plot(rho_set, rms_error)
    plt.xlabel('rho', fontdict=fontdict)
