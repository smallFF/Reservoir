...
if __name__ == '__main__':
    ...
    # model_1 = Model('lorenz', init_value=(0.1, 0.1, 0.1), 
    #                 t=(0, 50, 0.05), args=(10, 28, 8 / 3), 
    #                 N=400, rho=0.94,
    #                sigma=1.0, bias=1.0, alpha=1.0, beta=1e-08)

    # # rho optimal=1.25
    # rho_set = np.linspace(0.3, 1.5, 20)
    # rms_error = []
    # for rho in rho_set:
    #     model_1 = Model('lorenz', init_value=(0.1, 0.1, 0.1), 
    #                     t=(0, 50, 0.05), args=(10, 28, 8 / 3),
    #                     N=400, rho=rho,
    #                     sigma=1.0, bias=1.0, alpha=1, 
    ...
    # # alpha optimal=0.5
    # alpha_set = np.linspace(0.2, 1.0, 20)
    # par_set = alpha_set
    # xlabel = r'$\alpha$'
    # rms_error = []
    # for par in par_set:
